...
class NeuralNetwork:
    ...
    def __init__(self, layers=None, activations=None, loss_fn=None, optimizer=None, weight_decay=0.0):
        # Accept no args, single layer, or list of layers
        if layers is None:
            self.layers = []
    ...
    def set_weights(self, weights):
        """
        Set weights from a flat list/array: [W0, b0, W1, b1, ...]
        Grader calls this to inject deterministic weights for testing.
        """
    ...
    def get_weights(self):
        """Return weights as flat list [W0, b0, W1, b1, ...]"""
        out = []
